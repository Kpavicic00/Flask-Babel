...
@multilingual.route('/about', defaults={'lang_code': 'en'})
@multilingual.route('/onama', defaults={'lang_code': 'hr'})
def about():
    return render_template('multilingual/about.html', title=_('about'))

@multilingual.route('/blog')

def blog():
    return render_template('multilingual/blog.html', title=_('blog'))